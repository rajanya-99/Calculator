...
def cal():
    ...
    entry.grid(row=0, column=0, columnspan=4,
               sticky=N + W + S + E, padx=30, pady=30)

    cal_button_bg = 'darkred'
    num_button_bg = 'bisque3'
    other_button_bg = 'chocolate4'
    text_fg = 'azure'
    button_active_bg = 'chocolate4'

    num_button = partial(Button, root, fg=text_fg, bg=num_button_bg,
                         padx=10, pady=5, activebackground=button_active_bg)
    ...
    button3.grid(row=4, column=2, pady=7)

    button12 = cal_button(text='*', command=lambda: get_input(entry, '*'))
    button12.grid(row=2, column=3, pady=7)
    ...
    button16.grid(row=1, column=2, pady=7)
    ...
    button17.grid(row=5, column=3, pady=7)

    button18 = Button(root, text='^', fg=text_fg, bg=cal_button_bg, padx=10, pady=3,
                      command=lambda: get_input(entry, '**'))
    button18.grid(row=5, column=2, pady=7)
